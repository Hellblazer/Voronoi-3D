...
public class TetrahedralizationView2 extends GraphicsView2 {
    ...
    public TetrahedralizationView2() {
        this(new Tetrahedralization());
    }

    public TetrahedralizationView2(Tetrahedralization t) {
        super();
    ...
    public void update(boolean showVD, boolean showDT, boolean showFaces, boolean showAllPoints) {
        ...
        createDiagram();
        if (showVD) {
            render(voronoiFaces, COLOR_OF_VD, showFaces);
        }
        if (showDT) {
            render(delaunayFaces, COLOR_OF_DT, showFaces);
        }
        if (showAllPoints) {
            displaySpheres(vertices, 0.01F, COLOR_OF_DT);
        }
    }
